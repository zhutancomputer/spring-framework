...
public class StandardServletEnvironment extends StandardEnvironment implements ConfigurableWebEnvironment {
	...
	protected void customizePropertySources(MutablePropertySources propertySources) {
		// 创建StandardServletEnvironment对象, 子类构造方法会调用父类的构造方法, 查看父类StandardEnvironment
		// 查看父类StandardEnvironment的父类AbstractEnvironment的构造方法中调用了被子类覆写的customizePropertySources方法
		// 在父类StandardEnvironment的customizePropertySources方法添加了两个键
		// StandardServletEnvironment添加三个键
