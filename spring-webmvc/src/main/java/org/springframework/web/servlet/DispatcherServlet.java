...
public class DispatcherServlet extends FrameworkServlet {
	...
	static {
		...
		try {
			// DEFAULT_STRATEGIES_PATH默认的路径文件为org/springframework/web/servlet/DispatcherServlet.properties
			...
			// ExceptionResolver: ExceptionHandlerExceptionResolver/ResponseStatusExceptionResolver/DefaultHandlerExceptionResolver
	...
	protected void initStrategies(ApplicationContext context) {
		...
		// 从spring容器获取bean名字叫MULTIPART_RESOLVER_BEAN_NAME = "multipartResolver"的解析器, 作为文件上传
		initMultipartResolver(context);
		initLocaleResolver(context);
		initThemeResolver(context);

		// 优先从Spring容器中读取HandlerMappings, 若无则默认添加BeanNameUrlHandlerMapping RequestMappingHandlerMapping
		initHandlerMappings(context);

		// 优先从Spring容器中读取Adapters, 若无则默认添加HttpRequestHandlerAdapter SimpleControllerHandlerAdapter RequestMappingHandlerAdapter
		initHandlerAdapters(context);
		initHandlerExceptionResolvers(context);
		initRequestToViewNameTranslator(context);

		// 优先从Spring容器中读取ViewResolvers, 若无则默认添加InternalResourceViewResolver
