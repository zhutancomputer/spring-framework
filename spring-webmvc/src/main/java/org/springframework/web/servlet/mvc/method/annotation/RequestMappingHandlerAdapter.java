...
public class RequestMappingHandlerAdapter extends AbstractHandlerMethodAdapter
	...
	protected ModelAndView invokeHandlerMethod(HttpServletRequest request,
		...
		try {
			...
			// 找到贴有注解@InitBinder的方法并且存到ServletRequestDataBinderFactory中
			// ServletRequestDataBinderFactory内部维护着initBinderMethods的集合
			// 后续用这个factory创建WebDataBinder对象
			WebDataBinderFactory binderFactory = getDataBinderFactory(handlerMethod);

			// ModelFactory装着所有贴了注解@ModelAttribute但未贴@RequestMapping的方法
			...
			// 调用贴有注解@ModelAttribute但未贴@RequestMapping的方法, 并且根据默认名字或者指定名字把返回值放到model中
			...
			// 优先调用贴了注解@InitBinder方法
			// 针对贴了@ModelAttribute的参数来说
			// 参数绑定: 结合url
